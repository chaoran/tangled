...
//     '#tangle()': {
//
//       'should emit "update" to its parent': function() {
//         this.root.on('update', this.spy);
//         this.child.tangle(this.obj);
//         expect(this.spy.called).to.be.true;
//       },
//
//       "if there was an tangled object already,": {
//         beforeEach: function() {
//           this.child.tangle(this.obj);
//         },
//
//         'should emit "update"': function() {
//           this.child.on('update', this.spy);
//           this.child.tangle({});
//           expect(this.spy.called).to.be.true;
//         },
//
//         'should emit "delete" to its children': function() {
//           this.grandchild.on('delete', this.spy);
//           this.child.tangle({});
//           expect(this.spy.called).to.be.true;
//         },
//       },
...
//     '#delete()': {
//       beforeEach: function() {
//         /* make sure it has something tangled */
//         this.child.tangle({ beforeEach: '#delete()' });
//         this.spy = sinon.spy();
//       },
//
//       'should emit "delete" on itself': function() {
//         this.child.on('delete', this.spy);
//         this.child.delete();
//         expect(this.spy.called).to.be.true;
//       },
//
//       'should emit "delete" on its children': function() {
//         this.grandchild.on('delete', this.spy);
//         this.child.delete();
//         expect(this.spy.called).to.be.true;
//       },
//
//       'should emit "update" on its parent': function() {
//         this.root.on('update', this.spy);
//         this.child.delete();
//         expect(this.spy.called).to.be.true;
//       },
